@props([
    'clients' => [
        [
            'ref' => '#',
            'image' => '/assets/logo/agle-logo.jpeg',
            'whiteImage' => '/assets/logo/agle-logo.jpeg',
            'name' => 'AGLE',
        ],
        [
            'ref' => '#',
...
<footer class="wow fadeInUp relative z-10 bg-white pt-20 lg:pt-[100px]" data-wow-delay=".15s">
    ...
    <div class="container">
        <div class="w-full space-y-4">
            <p class="text-base text-dark-4 text-center">
            ...
            <div class="flex items-center justify-center">
                <a href="javascript:void(0)" class="px-3 text-dark-4 hover:text-dark-6">
