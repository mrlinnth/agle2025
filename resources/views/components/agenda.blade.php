            ...
            <table class="w-full divide-y-2 divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-2">Conference</td>
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-2">10:00 AM</td>
                        <td class="whitespace-nowrap px-4 py-2">Field Trip</td>
                        <td class="whitespace-nowrap px-4 py-2">Saraburi, Lopburi and Kanchanaburi Provinces
                        </td>
                    </tr>
                    <tr>
